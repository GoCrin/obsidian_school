...
Deeskalation : Abschwächung

## Ebene 1
Win - Win

Deeskalation: Lösung ohne Hilfe von außen möglich (1-3), oder Hilfe aus der direkten Umgebung (2-3).
...
Deeskalation: externe Betreuung/Begleitung (Mediation -> nimmt Vermittlerrolle ein)

4. Koalition / Gruppenbildung
5. Gesichtsverlust
6. Drohungen
...
8. Zersplitterung
9. beide in den Abgrund

Deeskalation: Schiedsgerichtsverfahren (7-8), Machteingriff von "oben" (Vorgesetzte / Vorgesetzter) (9)
