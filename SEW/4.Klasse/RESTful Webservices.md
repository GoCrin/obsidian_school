Webservices bieten die Möglichkeit Dienste, die ein Server zur Verfügung stellt anzusprechen. Restful Webservices folgen den REST Grundprinzipien. Zu diesen zählen:

<u>Eindeutige Identifikation von Ressourcen:</u> z.B. `https://shop.htlhl.at/products/75`
...
| `updateUser(int id, User user)` | `PATCH`, `PUT`     | `https://shop.htlhl.at/users/{id}` |
