...
Die Laufzeit der bei diesen Algorithmen steigt mit dem Logarithmus der Eingabegröße, dadurch sind sie sehr leistungsfähig.
...
Die Laufzeit bei diesem Algorithmen steigt proportional mit einem Polynom, das quadratische (n^2), kubische (n^3), uws. Glieder enthalten kann. O(n^2) ist schneller als O(n^3)
